...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | **Huanaco Huayta Elizabeth Lucero** <br> **TB1:** <br> Participé activamente en las reuniones de coordinación para definir nuestro caso de negocio. A partir de estas reuniones, desarrollé los Lean UX Assumptions, investigué sobre los competidores actuales en el mercado, y con esa información realicé un análisis competitivo, así como la redacción de estrategias a aplicar frente a nuestros competidores. Además, coordiné con los miembros del equipo asignados para establecer los parámetros que debíamos seguir en la elaboración de los wireframes y mockups. <br> **TP1:** <br> Desarrollo de frontend y correcciones del reporte. Aseguré que los cambios y mejoras propuestas en la interfaz fueran implementadas correctamente, y trabajé de manera conjunta con los demás miembros del equipo para ajustar los detalles técnicos necesarios en el frontend. <br> <br> <br> **Bohorquez Lerzundi Gerardo Sebastián** <br> **TB1:** <br>  Desarrollé el Lean UX Problem Statement, Lean UX Canvas y User Stories, y participé en la definición de la arquitectura de software orientada al dominio. <br> **TP1:** <br> Desarrollo de frontend y correcciones del reporte. Contribuí en la implementación de las interfaces de usuario y ajustes de diseño, además de realizar varias correcciones en el informe para asegurar la calidad del trabajo entregado. <br> <br> <br> **Jimenez Melgar Daniel Luciano** <br> **TB1:** <br> Realicé un análisis de competidores, llevé a cabo entrevistas, y elaboré un User Task Matrix para identificar las tareas críticas de la aplicación. También creé un glosario de Ubiquitous Language y diseñé wireframes y mock-ups para la versión móvil del landing page, así como para la aplicación web, asegurando una experiencia de usuario eficiente y funcional. <br> **TP1:** <br> Desarrollo de frontend y apoyo al equipo. Estuve involucrado en la implementación de la interfaz de usuario y proporcioné soporte adicional al equipo en diversas áreas del proyecto para asegurar que los objetivos fueran alcanzados de manera eficiente. <br> <br> <br> **Julca Cruz Renso Anthony** <br> **TB1:** <br> Realicé las 3 entrevistas basándome en una serie de preguntas para poder recolectar la información de manera satisfactoria. Luego, realicé las dos User Persona por cada segmento objetivo de nuestro trabajo, así como la User Task Matrix, Journey Mapping y el As-is Scenario Mapping. <br> **TP1:** <br> Desarrollo de frontend y apoyo al equipo. Apoyé en la implementación de las funcionalidades del frontend, trabajando junto al equipo para resolver los desafíos que surgían y asegurar que el desarrollo avanzara sin inconvenientes. <br> <br> <br> **Uribe Quispe, Jesús Guillermo** <br> **TB1:** Mediante llamados, organicé al equipo para poder completar exitosamente este primer entregable. La comunicación nos ayudó a entendernos mejor y a ir todos en una misma dirección, así como también generar un buen entorno. <br> **TP1:** <br> Desarrollo de frontend, correcciones del reporte y gestión del product backlog. Me encargué de ajustar detalles técnicos en el frontend, hacer correcciones en el informe y gestionar el backlog para organizar las tareas y prioridades del equipo. | Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | **Huanaco Huayta Elizabeth Lucero** <br> **TB1:** <br> Coordinamos como equipo para elaborar de manera conjunta los wireframes y mockups del landing page, así como los wireframes y mock-ups de la web application. Para lograrlo, establecimos un entorno colaborativo y planificamos las tareas de forma estructurada, asegurando que se cumpliera con el diseño del producto en los plazos acordados. Además, participé en las reuniones de planificación para desarrollar el Lean UX Assumptions, lo que nos permitió tener claros los objetivos del proyecto desde el inicio. <br> **TP1:** <br> Participé en la creación de un entorno de trabajo colaborativo para el desarrollo del frontend, asegurándome de que todos los miembros del equipo estuvieran alineados en los objetivos y tareas asignadas. También trabajé en las correcciones del reporte, lo cual ayudó a cumplir los objetivos del TP1 dentro de los plazos establecidos. <br> <br> <br> **Bohorquez Lerzundi, Gerardo Sebastián** <br> **TB1:** <br> Elaboré las Web Style Guidelines, diseñé el Information System, y planifiqué tareas usando Lean UX, manteniendo un enfoque centrado en el usuario. <br> **TP1:** <br> Colaboré activamente en la planificación del desarrollo del frontend, asegurando que todas las tareas se cumplieran dentro de los plazos establecidos y manteniendo un entorno inclusivo para la resolución de problemas en el desarrollo. También realicé correcciones importantes en el reporte del proyecto. <br> <br> <br> **Jimenez Melgar Daniel Luciano** <br> **TB1:** <br> Investigué los Competidores y realicé un Análisis de Competidores detallado para identificar sus características, ventajas y debilidades. Conduje Entrevistas con posibles usuarios. Además, elaboré un User Task Matrix para definir las tareas prioritarias que los usuarios deben completar en la plataforma. Creé un glosario de Ubiquitous Language para asegurar una comunicación clara y sin ambigüedades. <br> **TP1:** <br> Trabajé en la implementación del frontend, colaborando en la planificación de tareas junto al equipo y brindando soporte adicional donde se requería, asegurando que las metas fueran alcanzadas a tiempo. <br> <br> <br> **Julca Cruz Renso Anthony** <br> **TB1:** <br> Realicé las 3 entrevistas basándome en una serie de preguntas para poder recolectar la información de manera satisfactoria, Luego realicé las dos User Persona por cada segmento objetivo de nuestro trabajo, realicé la User Task Matrix, Journey Mapping y el As-is Scenario Mapping. <br> **TP1:** <br> Colaboré en el desarrollo del frontend, asegurando una buena coordinación y planificación con el equipo para cumplir los plazos del TP1. Brindé apoyo adicional en la resolución de problemas técnicos. <br> <br> <br> **Uribe Quispe, Jesús Guillermo** <br> **TB1:** <br> A través de la plataforma Github, hemos ordenado y designado tareas para cada integrante, esto fomenta la colaboración, el trabajo en equipo y el cumplimineto de varios objetivos. <br> **TP1:** <br> Creé un entorno colaborativo usando Github para la organización de tareas y el desarrollo del frontend, coordinando las correcciones necesarias en el reporte y gestionando el backlog para asegurar el cumplimiento de las metas en tiempo y forma. |
...
<tbody>
  ...
  <tr>
   ...
   <tr>
    <td>&nbsp;&nbsp;&nbsp;<br>US05&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Historias clínicas&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>UT02&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Gestión de historias clínicas en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración de la pantalla con las historias clínicas registradas en la base de datos&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
   ...
   <tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;<br>Pagos&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>UT03&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Pago de tratamientos en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración la pantalla pagos con el consumo de la FAKEAPI&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> Sebastián Bohorquez&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Done&nbsp;&nbsp;&nbsp;</td>
  </tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;<br>Menú&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>UT04&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Toolbar en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración del toolbar con rutas para cada sección&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> Jesús Uribe&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Done&nbsp;&nbsp;&nbsp;</td>
  </tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;<br>Soporte&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>UT05&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Soporte en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración del formulario para soporte&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
    ...
    <td>&nbsp;&nbsp;&nbsp;<br>Perfil&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>UT06&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Perfil en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración de las pantallas del perfil con consumo de API&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> Elizabeth Huanaco&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Done&nbsp;&nbsp;&nbsp;</td>
  </tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;<br>UT07&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Perfil en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración de la función para validar el cambio de contraseña y modificación del dato en la FAKEAPI&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> Elizabeth Huanaco&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Done&nbsp;&nbsp;&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>&nbsp;&nbsp;&nbsp;<br>Dashboard&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>UT08&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Dashboard en la Aplicación Web&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Elaboración del dashboard con el consumo de la FAKEAPI&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> 3&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br> Sebastián Bohorquez&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td>&nbsp;&nbsp;&nbsp;<br>Done&nbsp;&nbsp;&nbsp;</td>
  </tr>
